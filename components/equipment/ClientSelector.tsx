...
export default function ClientSelector({ value, onChange, error, label }: ClientSelectorProps) {
  ...
  const isNewClient = search && !clients.some(c => c.toUpperCase() === search.toUpperCase())
  ...
  return (
    <div className="relative" ref={containerRef}>
      ...
      {/* Tarjeta de Clientes */}
      {isOpen && (
        <div className="absolute z-50 w-full mt-2 bg-bg-card border border-border-subtle rounded-xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
              ...
              <>
                    ...
                    {filteredClients.map((client) => (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-sm text-text-primary font-medium">{client}</span>
                        </div>
                        {search.toUpperCase() === client.toUpperCase() && (
                ...
                {isNewClient && (
                  <div className="p-2 border-t border-border-subtle bg-neon-purple/5">
                    <button
                      type="button"
                      onClick={() => handleSelectClient(search)}
                    ...
                    >
                      ...
                      <div>
                        <p className="text-xs font-bold text-neon-purple uppercase tracking-tight">Nuevo Cliente</p>
